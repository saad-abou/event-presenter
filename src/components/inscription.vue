<template>
    <v-col class="inscrire" grid-list-xs >
    <v-row>
    <v-col align="center">
    ...
    <v-form
        ...
        <v-col>
            <v-alert
                border="right" 
                >
         Êtes-vous spécialiste de la santé ?
            <v-btn
            text
                 ...
                 <v-dialog
                    ...
                    <v-card>
                     <v-card-title class="headline">
                        ...
                        <v-card-text>
                        Malheureusement, vous ne pouvez pas accéder.<br>
                        Cet espace est réservé aux professionnels de la santé !
                        </v-card-text>
...
export default {
   data () {
      return {
        specialites: ['Medecin Generaliste', 'ORL','Autres'],
        dialog: false,
        dialog2:  false,
        email:'',
        nom:'',
